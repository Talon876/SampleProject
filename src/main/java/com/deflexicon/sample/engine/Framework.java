package com.deflexicon.sample.engine;
...
public class Framework extends Canvas
{
	...
	{
		g2d.setColor(Color.white);
		g2d.setFont(new Font("sans", Font.PLAIN, 72));
		g2d.drawString("Awesome Effects", frameWidth / 2 - 250, (int) (frameHeight * 0.65));
	}
